    ...
    <div className='flex justify-between items-center p-6 h-20 bg-white shadow-lg dark:bg-gray-900'>
      ...
      <div className='flex items-center gap-10'>
        <nav>
          ...
          <Link to={"seller/signup"} className='hover:text-orange-500 transition'>SignUp</Link>
          <Link to={"seller/login"} className='hover:text-orange-500 transition'>Login</Link>
